    ...
    return (
        <div className="flex justify-between items-center">
            ...
            <div className="md:hidden flex items-center">
                ...
                <div className={`${toggle ? ' translate-x-0' : 'translate-x-[100%]'} fixed top-0 left-0 w-screen h-screen z-[1] p-8 flex-col bg-black text-left transition transform ease-in-out delay-0`}>
